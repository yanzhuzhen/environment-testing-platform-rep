...
//        syslog("websocket连接成功,当前连接编号:"+session.getId()+",当前连接总数:"+onlineClientNumber.toString());
    }
...
//        syslog("websocket连接关闭,当前连接编号:"+session.getId()+",当前连接总数:"+onlineClientNumber.toString());
    }
...
//        syslog("websocket连接异常:"+error+",当前连接编号:"+session.getId()+",当前连接总数:"+onlineClientNumber.toString());
    }
...
//        syslog("websocket收到消息,来自连接编号:"+session.getId()+"的消息："+message);
    }
