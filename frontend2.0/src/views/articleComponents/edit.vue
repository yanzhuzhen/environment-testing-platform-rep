              ...
              <el-row>
                ...
                <el-col :span="10">
                  <el-form-item label-width="120px" label="发布时间" class="postInfo-container-item">
                    <el-input v-model="postForm.display_time" type="datetime" format="yyyy-MM-dd HH:mm:ss" />
                  </el-form-item>
                </el-col>
              </el-row>
            </div>
...
export default {
  ...
  methods: {
    getCurrentTime() {
      ...
      this.postForm.display_time = `${year}-${month}-${day}`
    },
    padZero(value) {
    ...
    async getEditArticle(){
      let res = await article.getEditArticle(this.$props.aid);
      if(res.success){
